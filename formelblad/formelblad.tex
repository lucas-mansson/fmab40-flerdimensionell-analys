...
\textbf{Satsen o mellanliggande värden}: Antag att den reellvärda funktionen $f(x, y)$ är kontinuerlig på en bågvis sammanhängande mängd $D$ i planet. Om $(a_1, b_1)$ och $(a_2, b_2)$ är punkter i $D$ sådana att $f(a_1, b_1) \neq f(a_2, b_2)$, så antar funktionen samtliga värden mellan $f(a_1, b_1)$ och $f(a_2, b_2)$.
